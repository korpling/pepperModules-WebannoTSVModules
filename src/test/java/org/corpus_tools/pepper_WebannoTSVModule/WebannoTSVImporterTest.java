...
/**
 * JUnit test for testing the * {@link WebannoTSVImporter} class. Please note,
 * that the test class is derived from {@link PepperImporterTest}.
 * 
 * @author Amir Zeldes
 */
public class WebannoTSVImporterTest {
	...
	public void setUp() {
		...
		// URI propertiesLoc =
		// URI.createFileURI("./src/test/resources/WebannoTSVImporter.properties");
		// getFixture().getProperties().setPropertyValues(new
		// File(propertiesLoc.toFileString()));
